...
export default function TopCategoryItemShopping({ categoryName, leftIcon, percentage, amountSpend }) {
        ...
        <View style={styles.topCategoryItemContainer}>
            <View style={styles.topCategoryItemLeftContainer}>
                ...
                <Text style={styles.topCategoryItemText}>
                    {CategoryExpense[0].CategoryName}
                </Text>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                <View>
                    <Text style={styles.topCategoryItemAmountSpendText}>
                        {CategoryExpense[0].TotalGroupExpense}
                    </Text>
                </View>
                <TouchableOpacity>
