...
export default function TopCategoryItemGroceries({ categoryName, leftIcon, percentage, amountSpend }) {
    ...
    return (
        <View style={styles.topCategoryItemContainer}>
            <View style={styles.topCategoryItemLeftContainer}>
                ...
                {CategoryExpense[1].CategoryName}
                </Text>
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                <View>
                    ...
                    {CategoryExpense[1].TotalGroupExpense}
                    </Text>
                </View>
                <TouchableOpacity>
